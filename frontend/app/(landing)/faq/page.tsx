...
const categories = [
  {
    ...
    items: [
      ...
      { q: 'Apakah hasilnya akurat?', a: 'Seakurat data yang Anda input. Taxonomy dikurasi manual dari job listings real. Semakin jujur Anda mengisi level skill, semakin akurat hasilnya.' },
      { q: 'Apa bedanya dengan LinkedIn Skills Assessment?', a: 'LinkedIn test per skill satu per satu. NaviKarier melihat keseluruhan profil Anda vs standar role yang Anda tuju, lalu memprioritaskan skill mana yang paling menggerakkan peluang.' },
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'Apakah NaviKarier menyimpan CV saya?', a: 'Untuk versi gratis, semua pemrosesan dilakukan di browser Anda. CV tidak dikirim ke server manapun. Untuk versi Pro, CV diproses dan dihapus setelah analisis selesai.' },
    ],
  },
  {
    title: 'Cara Kerja',
    items: [
      { q: 'Bagaimana langkah-langkah menggunakan NaviKarier?', a: '<strong>1. Ukur Skill Gap</strong>: Upload CV atau input skill manual.<br><br><strong>2. Temukan Prioritas</strong>: Sistem menghitung gap per-skill vs threshold industri.<br><br><strong>3. Belajar Terarah</strong>: Dapatkan rekomendasi skill yang harus diprioritaskan.<br><br><strong>4. Siap Bersaing</strong>: Track progress readiness score dari waktu ke waktu.' },
      ...
      <section className="page-hero">
        <div className="wrap">
          <Reveal>
            ...
            <p>Semua yang perlu Anda ketahui tentang NaviKarier, skill gap analysis, dan cara kerja platform kami.</p>
          </Reveal>
        </div>
      </section>
